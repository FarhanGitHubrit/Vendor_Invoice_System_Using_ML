...
### AI_driven Freight Cost Prediction & Invoice RIsk Flagging
...
if selected_model == "Freight Cost Prediction":
    ...
    with st.form("freight_cost"):
        ...
        submit_freight = st.form_submit_button("Predict Freight")
